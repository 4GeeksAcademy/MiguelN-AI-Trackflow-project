...
export const metadata: Metadata = {
  title: "TrackFlow | Logistics Modernization Across Mexico and Spain",
  description: "TrackFlow corporate website and operations surfaces, including candidate pipeline tooling.",
};
